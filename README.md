...
![Halaman Utama](Homepage.png)

**_Halaman Pertanyaan_ :**

![Halaman Pertanyaan](QuestionsPage.png)

**_Halaman Hasil Quiz_ :**

![Hasil Quiz](Resultpage.png)

### **Tech Stack & Dependencies**
*   **Bahasa**: Python 3.12.1
*   **Framework**: [![Streamlit](https://img.shields.io/badge/Streamlit-1.49.1-FFDD00?logo=streamlit)](https://streamlit.io/)
